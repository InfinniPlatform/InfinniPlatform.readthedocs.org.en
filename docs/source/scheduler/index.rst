...
can run jobs in accordance with specific time or period. There are two key things of scheduler: :doc:`schedule </scheduler/scheduler-cronexpression>`
and :doc:`job handler </scheduler/scheduler-jobhandler>`. Those can be bound by "one to many" relation. Schedule describes a specific handler call
...
InfinniPlatform job scheduler may run scheduled tasks in *cluster infrastructure*. This feature is delivered by :doc:`message queue </queues/index>`
